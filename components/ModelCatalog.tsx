    ...
    <section className="py-32 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-sm font-extralight text-gray-400 max-w-2xl mb-4">
          ...
          {/* Real Models Loaded! */}
          <div className="p-4 border border-green-500/30 bg-green-500/5 rounded-sm max-w-2xl">
            <p className="text-xs font-light text-green-200 mb-2">✅ Real STL Models Loaded!</p>
            <div className="text-[10px] font-extralight text-green-200/70 space-y-1">
              <p>• 10 GTA Online cars ready to view and print</p>
              <p>• Click any GTA model to see the actual 3D car</p>
              <p>• All models are FREE and ready to download</p>
              <p className="text-green-200/50 mt-2">Featuring: Progen T20, Zentorno, Elegy Retro, Turismo R, and more!</p>
            </div>
          </div>
        </div>
