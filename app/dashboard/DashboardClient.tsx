      ...
      <div className={`flex-1 transition-all duration-300 ${isCollapsed ? 'lg:ml-20' : 'lg:ml-56'}`}>
        <div className="p-4 sm:p-6 lg:p-12 max-w-7xl mx-auto">
          ...
          <div className="mb-8 sm:mb-12">
            ...
            {/* Chassis Row */}
            <div className="mb-8">
              <h3 className="text-sm font-light tracking-tight mb-3 text-gray-500 uppercase">Chassis</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2, 3].map((num) => (
                  <div key={`chassis-${num}`} className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <Box className="w-10 h-10 mx-auto mb-2 text-gray-600" />
                        <p className="text-xs font-light text-gray-600">Add Model {num}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            {/* Exterior Row */}
            <div className="mb-8">
              <h3 className="text-sm font-light tracking-tight mb-3 text-gray-500 uppercase">Exterior</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2, 3].map((num) => (
                  <div key={`exterior-${num}`} className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <Box className="w-10 h-10 mx-auto mb-2 text-gray-600" />
                        <p className="text-xs font-light text-gray-600">Add Model {num}</p>
            ...
            {/* Interior Row */}
            <div className="mb-8">
              <h3 className="text-sm font-light tracking-tight mb-3 text-gray-500 uppercase">Interior</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2, 3].map((num) => (
                  <div key={`interior-${num}`} className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <Box className="w-10 h-10 mx-auto mb-2 text-gray-600" />
                        <p className="text-xs font-light text-gray-600">Add Model {num}</p>
            ...
            {/* Rims Row */}
            <div className="mb-8">
              <h3 className="text-sm font-light tracking-tight mb-3 text-gray-500 uppercase">Rims</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {/* Rim Model 1 */}
                <div className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                  <CategoryModel3D modelPath="/3d-models/rims/a03fad0e-32fb-4408-af46-5c328c7320e8_white_mesh.glb" />
                  <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black via-black/80 to-transparent pointer-events-none">
                    <p className="text-xs font-light text-white">Sport Rim</p>
                  </div>
                </div>

                {/* Rim Model 2 - Placeholder */}
                <div className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <Box className="w-10 h-10 mx-auto mb-2 text-gray-600" />
                      <p className="text-xs font-light text-gray-600">Add Model 2</p>
                    </div>
                  </div>
                </div>

                {/* Rim Model 3 - Placeholder */}
                <div className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <Box className="w-10 h-10 mx-auto mb-2 text-gray-600" />
                      <p className="text-xs font-light text-gray-600">Add Model 3</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Steering Row */}
            <div className="mb-8">
              <h3 className="text-sm font-light tracking-tight mb-3 text-gray-500 uppercase">Steering</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {/* Steering Model 1 */}
                <div className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                  <CategoryModel3D modelPath="/3d-models/steering/steering-wheel-1.glb" />
                  <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black via-black/80 to-transparent pointer-events-none">
                    <p className="text-xs font-light text-white">Racing Wheel</p>
                  </div>
                </div>

                {/* Steering Model 2 - Placeholder */}
                <div className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <Box className="w-10 h-10 mx-auto mb-2 text-gray-600" />
            ...
            {/* Seat Row */}
            <div className="mb-8">
              <h3 className="text-sm font-light tracking-tight mb-3 text-gray-500 uppercase">Seat</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2, 3].map((num) => (
                  <div key={`seat-${num}`} className="group relative overflow-hidden border border-white/10 h-48 bg-gradient-to-b from-white/5 to-black hover:border-white/20 transition-all">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <Box className="w-10 h-10 mx-auto mb-2 text-gray-600" />
                        <p className="text-xs font-light text-gray-600">Add Model {num}</p>
